...
public interface ITransactionsApiClient
{
  ...
  Task<bool> AssignTransactionAsync(int transactionId, int lineId, int envelopeId, string vendor, string description, string notes, bool isHidden = false, CancellationToken cancellationToken = default);
