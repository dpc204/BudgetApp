...
public sealed record BackupSetDto(string PartitionKey, DateTime BackupDate, int TableCount, long TotalSizeBytes);
public sealed record BackupTableDto(string PartitionKey, string RowKey, string TableName, int RecordCount, long SizeBytes, DateTime BackupDate);
