...
public class HandlerTests
{
    ...
    /// </summary>
    [Fact]
    public async Task Handle_EmptyStringProperties_ReturnsResponseWithEmptyStrings()
    {
        // Arrange
        await using var context = new BudgetContext(CreateInMemoryOptions(), null);
        ...
        response.CategoryId.Should().BeEmpty();
    }
    ...
    public async Task Handle_VeryLongStrings_CorrectlyMapsLongStrings()
    {
        ...
        response.CategoryId.Should().HaveLength(10000);
    }
}
